...
### <img src="https://img.icons8.com/fluency/48/download.png" width="24" align="absmiddle"/> 立即下載

<a href="https://play.google.com/store/apps/details?id=com.sufu.photo.mark">
    <img alt="Get it on Google Play" src="https://play.google.com/intl/en_us/badges/static/images/badges/zh-tw_badge_web_generic.png" width="200"/>
</a>

---

## <img src="https://img.icons8.com/fluency/48/open-book.png" width="28" align="absmiddle"/> 產品介紹
...
## <img src="https://img.icons8.com/fluency/48/time-machine.png" width="28" align="absmiddle"/> 更新日誌

**v1.2.0 (2026-03-26)**
- 新增全面國際化支持，全新適配英語、日語及繁體中文。
- 優化渲染層性能，極大地解決了進入 `DiscernActivity` 頁面的卡頓問題。
- 重構彈窗与設置頁面的 UI，完美兼顧深色模式並改進長圖判定及交互邏輯。

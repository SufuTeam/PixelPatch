...
- 优化渲染层性能，极大地解决了进入 `DiscernActivity` 页面的卡顿问题。
- 重构弹窗与设置页面的 UI，完美兼顾深色模式并改进长图判定及交互逻辑。

**v1.1.0 (2026-03-22)**
- 彻底使用 Jetpack Compose 重构图片标注界面（`DiscernScreen`）。
- 增强文本识别与打码互动逻辑，支持长按细粒度选择区块。
- 新增 EXIF 信息快捷查看、设置应用偏好参数及统一的底部操作工具栏。

**v1.0.0**
- 初始版本发布，带来基于 OpenCV 的文本区域识别检测系统与手动无极马赛克笔刷工具。
